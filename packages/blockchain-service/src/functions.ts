...
export function normalizeHash(hash: string, options?: { lowercase?: boolean }): string {
...
export function formatTokenNumber(value: string | number, decimals = 0) {
  return utils.fromWei(value, decimals)
}

export function parseTokenNumber(value: string | number, decimals = 0) {
