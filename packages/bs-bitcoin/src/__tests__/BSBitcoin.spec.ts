...
describe('BSBitcoin', () => {
  ...
  it('Should be able to generate an account from mnemonic', () => {
    ...
    const secondAccount = service.generateAccountFromMnemonic(mnemonic, 1)
  ...
  it('Should be able to generate an account from mnemonic using Testnet', () => {
    service = new BSBitcoin('test', BSBitcoinConstants.TESTNET_NETWORK)
  ...
  it('Should be able to generate an account from public key', () => {
    const account = service.generateAccountFromPublicKey(mainnetAddress)
    const legacyAccount = service.generateAccountFromPublicKey(mainnetLegacyAddress)
    const p2shAccount = service.generateAccountFromPublicKey(mainnetP2SHAddress)
  ...
  it('Should be able to generate an account from public key using Testnet', () => {
    service = new BSBitcoin('test', BSBitcoinConstants.TESTNET_NETWORK)

    const account = service.generateAccountFromPublicKey(testnetAddress)
    const legacyAccount = service.generateAccountFromPublicKey(testnetLegacyAddress)
    const p2shAccount = service.generateAccountFromPublicKey(testnetP2SHAddress)
  ...
  it('Should be able to generate an account from key', () => {
    const account = service.generateAccountFromKey(mainnetKey)
  ...
  it('Should be able to generate an account from key using Testnet', () => {
    service = new BSBitcoin('test', BSBitcoinConstants.TESTNET_NETWORK)

    const account = service.generateAccountFromKey(testnetKey)
  ...
  it.skip('Should be able to calculate fee using Testnet', async () => {
    ...
    const senderAccount = service.generateAccountFromKey(testnetKey)
  ...
  it("Shouldn't be able to calculate fee if there isn't UTXO available using Testnet", async () => {
    ...
    const mnemonic = BSKeychainHelper.generateMnemonic()
    const senderAccount = service.generateAccountFromMnemonic(mnemonic, 0)
