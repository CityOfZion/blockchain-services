...
- Add nonce in Ethereum transfer
...
- Change buildTransferParams visibility
...
- Improve validations for getTokenPrices
...
- Fix retry validation on Ledger
...
- Update license
- Change default node for Polygon
