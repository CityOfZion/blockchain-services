...
export class Neo3NeoXBridgeOrchestrator<N extends string> implements IBridgeOrchestrator<N> {
  ...
  #internalAccountToUse: TBridgeValue<Account<N>> = { value: null, loading: false, error: null }
  ...
  get #accountToUse(): TBridgeValue<Account<N>> {
    return this.#internalAccountToUse
  }
  set #accountToUse(value: Partial<TBridgeValue<Account<N>>>) {
