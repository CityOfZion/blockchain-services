...
This log was last generated on Thu, 09 Apr 2026 18:51:16 GMT and should not be manually modified.
...
- Replace DoraCDSNeoLegacy with ClaimServiceNeoLegacy, moving claim logic out of BSNeoLegacy
- Prefix internal methods with underscore and make TokenServiceNeoLegacy generic
...
- Apply new claim, transfer, transaction and explorer interfaces and types
...
## 1.14.0
Thu, 06 Nov 2025 14:45:46 GMT

### Minor changes

- Remove migration feature
...
- Update Dora TS SDK and use the NeoLegacyREST to get unclaimed GAS
