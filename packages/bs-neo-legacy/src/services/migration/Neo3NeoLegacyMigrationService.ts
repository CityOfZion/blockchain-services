...
import { BalanceResponse, BSBigNumberHelper, BSUtilsHelper, TransactionResponse } from '@cityofzion/blockchain-service'
...
export class Neo3NeoLegacyMigrationService<N extends string> {
  ...
  calculateNeoLegacyMigrationAmounts(balance: BalanceResponse[]): TNeo3NeoLegacyMigrationNeoLegacyAmounts {
