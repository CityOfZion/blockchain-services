...
- Standardize network names and fix lint
...
- Replace GhostMarket with Moralis for NFT handling.
...
- Move bridge data extraction into Neo3NeoXBridgeService with dedicated getTransactionData
- Prefix internal methods with underscore and remove legacy transaction type fields
...
- Fix interfaces, types and update ESLint version
...
- Add test to ensure Blockscout's TestNet is up to date
