...
import { DORA_URL } from '@cityofzion/blockchain-service'
...
describe('SimpleSwapApi', () => {
  ...
  const gasCurrency: SimpleSwapApiCurrency<'neo3'> = {
    ...
    addressTemplateUrl: `${DORA_URL}/address/neo3/mainnet/{address}`,
    txTemplateUrl: `${DORA_URL}/transaction/neo3/mainnet/{txId}`,
    blockchain: 'neo3',
  }
